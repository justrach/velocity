// this is a local terminal app to demonstrate that you can use dartive to create a terminal app! and run it locally, the main repository for this would be at
